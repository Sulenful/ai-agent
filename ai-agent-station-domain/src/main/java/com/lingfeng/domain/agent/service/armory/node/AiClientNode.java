...
import com.lingfeng.domain.agent.model.valobj.AiClientSystemPromptVO;
import com.lingfeng.domain.agent.model.valobj.AiClientVO;
 ...
 * @description
 */
@Slf4j(topic = "AiClientNode")
@Service
public class AiClientNode extends AbstractArmorySupport{
    @Override
    protected String doApply(ArmoryCommandEntity requestParameter, DefaultArmoryStrategyFactory.DynamicContext dynamicContext) throws Exception {
        log.info("【AiClientNode】Ai Agent 构建节点，客户端{}", JSON.toJSONString(requestParameter));
